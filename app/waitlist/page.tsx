...
export default function Home() {
  return (
    <>
      <Toaster />
      <section className="w-screen h-dvh grid grid-cols-1 md:grid-cols-2 gap-6 bg-[#e9ecef]">
        ...
        <main className="flex flex-col gap-8 md:mt-8 -mt-24 justify-center px-6 pb-10">
          ...
          <p className="text-zinc-700">
            Welcome to Echo. Rank your favorite albums, share your ratings with
